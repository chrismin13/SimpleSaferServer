...
class DriveHealthSupportTests(unittest.TestCase):
    @patch("simple_safer_server.modules.drive_health.service.drive_health_command_adapter.smartctl_help")
    @patch("simple_safer_server.modules.drive_health.service.shutil.which")
